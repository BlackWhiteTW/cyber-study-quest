...
function placeholder(n){ return Array.from({length:n},(_,i)=>({id:"GEN-"+i})); }
window.CSQ_QUESTION_BANK = {};
Object.keys(window.CSQ_META).forEach(s=>{ window.CSQ_QUESTION_BANK[s] = { easy: placeholder(9999), normal: placeholder(9999), hard: placeholder(9999) }; });
...
const V65_CHINESE_ITEMS = normalizeChineseJsonBank(window.MY_CHINESE_BANK || [
  {
    "id": "CHI-001",
    "stage": "intro",
    "type": "形音義（語境辨析）",
